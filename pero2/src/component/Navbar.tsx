...
function StickyBottomNavigation() {
  ...
  return (
    <nav className=" fixed bottom-12 left-[30%] max-w-full gap-x-2 gap-y-2 rounded-[var(--border-radius--menu-wrapper)] bg-[rgba(26,27,30,0.4)] border flex-col flex  p-[9px] max-sm:p-[5px] border-solid border-[#222325] transition-custom ">
      {learnVisible && (
